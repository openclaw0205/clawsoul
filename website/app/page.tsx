      ...
      <main className="flex-1 lg:ml-64">
        ...
        <section className="px-6 lg:px-12 py-12 lg:py-16 border-b border-gray-800">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 mb-8">
              ClawSoul is a community-driven marketplace with{" "}
              <span className="text-orange-400 font-semibold">{souls.length}</span> soul templates.
              <br />
              Give your OpenClaw AI assistant expertise instantly.
            </p>
            ...
            <div className="relative max-w-xl">
              <input
                type="text"
                placeholder="Search souls by name, tag, or description..."
        ...
        <section id="souls" className="px-6 lg:px-12 py-12">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold text-white">All Souls</h2>
            <span className="text-sm text-gray-500">{souls.length} available</span>
          </div>
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-gray-500">by @{soul.author}</p>
                  </div>
                </div>
        ...
        <section className="px-6 lg:px-12 py-16 border-t border-gray-800">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-8">
              Have expertise to share? Create a soul template and help others transform their AI assistants.
            </p>
            <a
              href="https://github.com/openclaw0205/clawsoul/blob/main/CONTRIBUTING.md"
              target="_blank"
